      ...
      <Popover>
        <PopoverTrigger asChild>
          <div className="border rounded-md p-2 flex items-center ">
            <div className="flex">
              <Avatar
                className={cn(withMinimal ? `size-8` : `size-12`, `rounded-md`)}
              >
                <AvatarImage
            ...
            {withMinimal ? null : <ChevronsUpDown className="text-gray-500" />}
          </div>
        </PopoverTrigger>
        <PopoverContent
          side="top"
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <Link className="flex gap-2" to="#">
              <HelpCircle />
              {!withMinimal ? <h1>Hello & Support</h1> : ""}
            </Link>
            <Link className="flex gap-2" to="#">
              <SettingsIcon />
              {!withMinimal ? <h1>Settings</h1> : ""}
            </Link>
            <Link className="flex gap-2 text-red-600" to="#">
              <LogOutIcon />
              {!withMinimal ? <h1>Logout</h1> : ""}
            </Link>
          </div>
        </PopoverContent>
      </Popover>
